export default {
  ...
  walking: [
    ...
    {
      id: 17,
      name: "Adidas Ultraboost 21 Walk",
      price: 180.55,
      type: "for men",
      sale: 0.25,
      stars: 4.7,
  ...
  training: [
    ...
    {
      id: 25,
      name: "Adidas Adipower Weightlifting II",
      price: 200.3,
      type: "for men",
      sale: 0,
      stars: 4.7,
  ...
  specialOffer: {
    id: 99,
    name: "Asics Gel-Kayano Ultrawave",
    price: 130.45,
    type: "for men",
    sale: 0.4,
    stars: 4.9,
